            ...
            <div className="container px-4 md:px-6 mx-auto">
              <div className="flex flex-col justify-center items-center space-y-4 text-center">
                ...
                <div className="mx-auto flex flex-col gap-2 min-[400px]:flex-row">
                  ...
                  <Button variant="outline" className="border-[#fbc710] text-black hover:bg-[#fbc710]/10">Learn More</Button>
                </div>
              </div>
            </div>
          </section>
              ...
              <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8 mt-8 max-w-6xl">
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    <Wallet className="h-8 w-8 mb-2 text-[#fbc710]" />
                    <CardTitle>Adjusted Gross Income (AGI)</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>Earned Income Tax Credit</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    <Landmark className="h-8 w-8 mb-2 text-[#fbc710]" />
                    <CardTitle>Tax Bracket</CardTitle>
                  </CardHeader>
                  <CardContent>
