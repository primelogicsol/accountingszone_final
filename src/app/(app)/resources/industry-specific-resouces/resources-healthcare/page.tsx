              ...
              <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8 mt-8 max-w-6xl">
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>Medical Practice Tax Planning</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>Healthcare Billing & Reimbursement</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">
                      Navigate insurance and Medicaid/Medicare payment systems.
                    </p>
                  </CardContent>
                </Card>
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>HIPAA-Compliant Documentation</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">
                      Secure patient and financial data management systems.
                    </p>
                  </CardContent>
                </Card>
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>Payroll & Compensation Optimization</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">
                ...
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>Grants & Funding Assistance</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">
                      Identify opportunities for non-profit and research funding.
                    </p>
                  </CardContent>
                </Card>
              </div>
