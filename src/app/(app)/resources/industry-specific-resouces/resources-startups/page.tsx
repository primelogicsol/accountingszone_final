              ...
              <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8 mt-8 max-w-6xl">
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>Business Structure & Tax Strategy</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>Startup Tax Credits & Deductions</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">
                ...
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>Investor & Venture Capital Tax Planning</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">Optimize funding structures for tax efficiency.</p>
                  </CardContent>
                </Card>
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    <TrendingUp className="h-8 w-8 mb-2 text-[#fbc710]" />
                    <CardTitle>Financial Modeling & Cash Flow</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">
                ...
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>Employee Stock Option Taxation</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">
                      Compliance with equity-based compensation regulations.
                    </p>
                  </CardContent>
                </Card>
              </div>
